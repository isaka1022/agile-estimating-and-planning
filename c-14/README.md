...
## タスクの見積もりとストーリーポイントの関係

- ストーリーポイントと、その実装にかかる時間との間に強い相関があるとチームが思い始めると、チームは道を誤る
- ストーリーポイントの時間はあくまでも平均である

### 1週間の区切り

- イテレーションと1週間の区切りを合わせる必要はない

## まとめ

- イテレーション計画では1回のイテレーションでの具体的な作業を扱う
- リリース計画が3ヶ月から6ヶ月の期間を対象とするのに対し、イテレーション計画は1回のイテレーションだけを対象とする
- 大きなユーザーストーリーをタスクに分割する
- タスクは理想時間を単位として見積もる
